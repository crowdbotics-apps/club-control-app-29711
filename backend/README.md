...
## Project Structure
    ...
    ├── club_control_app_29711  # Django project configurations
...
1. Clone this repo and `cd club_control_app_29711`
...
2. Clone this repo and `cd club_control_app_29711`
